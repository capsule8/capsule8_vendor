...
func (*GetEventsRequest) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*GetEventsResponse) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*TelemetryEvent) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func init() { proto.RegisterFile("capsule8/api/v0/telemetry_service.proto", fileDescriptor7) }

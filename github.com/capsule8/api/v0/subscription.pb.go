...
type FilterPredicate struct {
	...
	//	*FilterPredicate_SignedIntValue
	//	*FilterPredicate_UnsignedIntValue
...
type FilterPredicate_SignedIntValue struct {
	SignedIntValue int64 `protobuf:"zigzag64,21,opt,name=signed_int_value,json=signedIntValue,oneof"`
}
type FilterPredicate_UnsignedIntValue struct {
	UnsignedIntValue uint64 `protobuf:"varint,22,opt,name=unsigned_int_value,json=unsignedIntValue,oneof"`
}
type FilterPredicate_StringValue struct {
	StringValue string `protobuf:"bytes,23,opt,name=string_value,json=stringValue,oneof"`
}

func (*FilterPredicate_SignedIntValue) isFilterPredicate_Value()   {}
func (*FilterPredicate_UnsignedIntValue) isFilterPredicate_Value() {}
...
func (m *FilterPredicate) GetSignedIntValue() int64 {
	if x, ok := m.GetValue().(*FilterPredicate_SignedIntValue); ok {
		return x.SignedIntValue
	}
	return 0
}

func (m *FilterPredicate) GetUnsignedIntValue() uint64 {
	if x, ok := m.GetValue().(*FilterPredicate_UnsignedIntValue); ok {
...
func (*FilterPredicate) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _FilterPredicate_OneofMarshaler, _FilterPredicate_OneofUnmarshaler, _FilterPredicate_OneofSizer, []interface{}{
		(*FilterPredicate_SignedIntValue)(nil),
		(*FilterPredicate_UnsignedIntValue)(nil),
...
func _FilterPredicate_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*FilterPredicate)
	switch tag {
	case 21: // value.signed_int_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeZigzag64()
		m.Value = &FilterPredicate_SignedIntValue{int64(x)}
		return true, err
	case 22: // value.unsigned_int_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Value = &FilterPredicate_UnsignedIntValue{x}
		return true, err
...
var fileDescriptor9 = []byte{
	...
	,
}

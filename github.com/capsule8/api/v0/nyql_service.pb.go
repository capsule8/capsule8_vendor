...
func (*CreateSubscriptionRequest) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*CreateSubscriptionResponse) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func init() { proto.RegisterFile("capsule8/api/v0/nyql_service.proto", fileDescriptor5) }
